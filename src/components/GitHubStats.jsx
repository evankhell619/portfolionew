...
const LEVEL_COLORS = {
    ...
    1: '#500724',   // darkest pink
    2: '#831843',
    3: '#db2777',
    4: '#f472b6',   // bright pink
};
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="mb-12 md:mb-16 flex flex-col lg:flex-row lg:items-end justify-between gap-8">
                    ...
                    <Gsap.a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex items-center gap-3 w-fit border border-pink-400/30 text-pink-400 px-6 py-3 hover:bg-pink-400 hover:text-black transition-all font-mono text-sm font-bold uppercase tracking-[0.14em] md:tracking-[0.2em] group"
                    >
                        <Terminal size={16} />
                        Launch_Profile
                ...
                <div className="flex flex-col xl:flex-row gap-6 md:gap-8 w-full">
                    ...
                    >
                        ...
                        <div className="bg-[#0A0A0A] p-6 lg:p-8 flex flex-col justify-between aspect-square group hover:bg-[#111111] transition-colors">
                            <div className="flex items-center justify-between text-white/40 group-hover:text-pink-400 transition-colors">
                                <Code size={20} />
                                <span className="font-mono text-[10px] uppercase tracking-[0.12em] md:tracking-[0.16em] font-bold">REPOS</span>
                            </div>
                            <div>
                                <p className="text-4xl lg:text-6xl text-white font-black tracking-tighter group-hover:text-pink-400 transition-colors">
                    ...
                    >
                        <div className="flex justify-between items-start border-b border-white/10 pb-6 mb-8">
                            ...
                            <div className="hidden sm:flex items-center gap-2 font-mono text-xs uppercase tracking-[0.12em] md:tracking-[0.16em] text-white/40">
                                ...
                                <span className="w-3 h-3 bg-[#500724]" />
                                <span className="w-3 h-3 bg-[#831843]" />
                                <span className="w-3 h-3 bg-[#db2777]" />
                                <span className="w-3 h-3 bg-[#f472b6] mr-2" />
                                More
                            </div>
                        </div>
                        ...
                        <div className="mt-8 pt-6 border-t border-white/10 flex justify-between items-center font-mono text-xs md:text-sm text-white/40">
                            ...
                            <div className="uppercase tracking-[0.12em] md:tracking-[0.16em] text-pink-400/80 animate-pulse">
                                ONLINE
                            </div>
                        </div>
                    </Gsap.div>
