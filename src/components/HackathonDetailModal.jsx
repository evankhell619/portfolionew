...
const galleryImages = [
    { src: '/placeholder.svg', alt: 'Base Realms - Onchain Battle Game on Base App' },
    { src: '/placeholder.svg', alt: 'QRIS Adoption - Normies Friendly Onboarding' },
    { src: '/placeholder.svg', alt: 'Just 5 Steps to Play' },
    { src: '/placeholder.svg', alt: 'Trade Collectibles & Mint NFTs' },
    { src: '/placeholder.svg', alt: 'System Architecture & Flow' },
    { src: '/placeholder.svg', alt: 'Team Information & Project Roadmap' },
];
...
const links = {
    ...
    github: 'https://github.com/evan/Base-Realms',
                            ...
                            <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
                                ...
                                <div className="mt-10 flex flex-wrap justify-center gap-4">
                                    <a href={links.live} target="_blank" rel="noreferrer"
                                        className="bg-pink-400 text-black px-8 py-3.5 font-bold uppercase text-xs tracking-wider hover:bg-black hover:text-white transition-all duration-300 rounded-[2px] flex items-center gap-2">
                                        ...
                                        <ul className="space-y-4">
                                            {[
                                                ...
                                                <li key={i} className="flex gap-4">
                                                    <span className="mt-1.5 shrink-0 block w-1.5 h-1.5 bg-pink-500 rounded-full" />
                                        ...
                                        {highlights.map((h, i) => {
                                            ...
                                            return (
                                                <div key={i} className="group flex flex-col">
                                                    <div className="w-10 h-10 bg-black/5 rounded-full flex items-center justify-center mb-4 group-hover:bg-pink-400 group-hover:text-black transition-colors duration-300">
