      ...
      <div className="max-w-[1400px] mx-auto px-5 sm:px-6 md:px-12 relative z-10 flex flex-col justify-between min-h-[50vh]">
            ...
            <div className="flex flex-col gap-4">
              ...
              {[
                ...
                <button
                  ...
                  className="text-left font-mono text-xs md:text-sm font-bold uppercase text-white/60 hover:text-pink-400 transition-colors flex items-center gap-3 group py-1"
                >
                  <span className="w-1.5 h-1.5 bg-white/20 group-hover:bg-pink-400 transition-colors" />
                  <span className="tracking-[0.14em] md:tracking-[0.2em] relative">
                    {item.label}
                    <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-pink-400 group-hover:w-full transition-all duration-300" />
                  </span>
                </button>
              ))}
            </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-4">
          <div className="flex items-center gap-3 font-mono text-[10px] md:text-xs text-white/40 uppercase tracking-[0.14em] md:tracking-[0.2em]">
            ...
            <div className="flex items-center gap-2 text-pink-400 bg-pink-400/10 px-2 flex-grow-0 min-w-16 justify-center py-0.5 border border-pink-400/20 yg">
              ONLINE
            </div>
          </div>
