...
const AchievementCard = ({ achievement, index, onClick }) => {
  ...
  return (
    ...
    >
      <div className="absolute -right-10 -top-10 h-36 w-36 rounded-full bg-pink-300/[0.16] blur-3xl opacity-35 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
      <div className="absolute inset-0 bg-gradient-to-br from-pink-200/[0.08] via-transparent to-transparent opacity-60 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
  ...
  return (
    <section id="about-section" className="py-20 md:py-28 w-full relative bg-[#FAF9F6] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none">
        <div className="absolute right-0 top-1/4 w-[520px] h-[520px] bg-pink-300/[0.07] rounded-full blur-[110px]" />
      ...
      <div className="max-w-[1380px] mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          <span className="w-[6px] h-[6px] rounded-full bg-pink-500 shrink-0" />
        ...
        <div className="grid lg:grid-cols-[400px_1fr] xl:grid-cols-[440px_1fr] gap-14 lg:gap-20 xl:gap-28 items-start">
          ...
          >
            ...
            <div className="relative">
              <div className="absolute -top-2.5 -left-2.5 w-full h-full border border-pink-400/25 rounded-[4px] pointer-events-none" />
              ...
              <div className="relative aspect-[4/5] w-full rounded-[4px] overflow-hidden border border-black/[0.07] bg-black/[0.04] group">
                ...
                <picture>
                  <source srcSet="/aboutpp.png" type="image/svg+xml" />
                  <img
                    src="/aboutpp.png"
                    alt="Evan"
                    loading="lazy"
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <span className="font-mono text-[10px] md:text-[10.5px] uppercase tracking-[0.2em] text-black/35">
                .NET · Backend Integration · Power Automate
              </span>
            </Gsap.div>
            ...
            >
              <p>
                I'm <strong className="text-black font-semibold">Evan</strong>, a Full-Stack Developer focused on building internal applications for one of the largest mining companies in North Sumatra.
              </p>
              <p>
                I build division-specific apps that support operational workflows, improve data access, and help each team work with clearer, more reliable digital tools.
              </p>
            </Gsap.div>
            ...
            {achievements.length > 0 && (
              ...
              >
                <div className="flex items-center gap-3 mb-5">
                  <span className="w-[5px] h-[5px] rounded-full bg-pink-500 shrink-0" />
